...
import pageobjects.PO_About;
import pageobjects.PO_Signin;
...
public class TS_Google_JUnit {
    ...
    public void setupTestCase(TestInfo testInfo) {
        ...
        po_Gmail = new PO_Gmail(driver);
        po_Signin = new PO_Signin(driver);
    ...
    /**
     * Test Case (TC) for Google search for "Tom and jerry".
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - Google - Search for Tom and Jerry")
    ...
    /**
     * Test Case (TC) for Google search by voice for "Phones".
     */
    @Test
    @Tag("e2e_test")
    @DisplayName("TC - Google - Search for phones")
    public void tc_google_search_for_Phones() {
        FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://www.google.com"));
        FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
        FW_CustomAssertJU.autoPass(po_Home.clickGoogleSearchByVoice());
        FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
    ...
    //     FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://www.google.com"));
    //     FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
    //     FW_CustomAssertJU.autoPass(po_Home.enterSearch("I'm feeling lucky"));
    //     FW_CustomAssertJU.autoPass(po_Home.clickBaseGoogleSearch());
    //     FW_CustomAssertJU.autoPass(po_Results.validateOnPage());
...
// @Test
//     @Tag("e2e_test")
//     @DisplayName("TC - Google - gmail")
//     public void tc_google_gmail() {
//         FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://www.google.com"));
//         FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
//         FW_CustomAssertJU.autoPass(po_Home.clickGoogleGmail());
//         FW_CustomAssertJU.autoPass(po_Gmail.validateOnPage());
//         FW_CustomAssertJU.autoPass(po_Gmail.clickSignIn());
//         FW_CustomAssertJU.autoPass(po_Signin.validateOnPage());
//         FW_CustomAssertJU.autoPass(po_Signin.enterEmail("aline@muraho.tech"));
//         FW_CustomAssertJU.autoPass(po_Signin.clickNext());
//         FW_CustomAssertJU.autoPass(po_Signin.validateOnPage());
...
//     }
    ...
    // @Test
    // @Tag("e2e_test")
    // @DisplayName("TC - Google - about")
    // public void tc_google_about() {
    //     FW_CustomAssertJU.autoPass(po_Home.navigateTo("https://www.google.com"));
    //     FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
    //     FW_CustomAssertJU.autoPass(po_Home.clickGoogleAbout());
    //     FW_CustomAssertJU.autoPass(po_About.validateOnPage());
    //     FW_CustomAssertJU.autoPass(po_About.clickProducts());
    //     FW_CustomAssertJU.autoPass(po_About.validateOnPage());
    //     FW_ScreenUtils.takeScreenshot(driver, "Login", FW_ConfigMgr.getScreenCaptureDirectory());
    // }
    // ================================================================================
    /**
